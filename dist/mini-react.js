    ...
    */
    ...
    function commitEffectHooks() {
        function runCleanup(fiber) {
            ...
            if (!fiber)
                return;
            (_b = (_a = fiber.alternate) === null || _a === void 0 ? void 0 : _a.effectHooks) === null || _b === void 0 ? void 0 : _b.forEach((action, index) => {
                var _a, _b;
                const deps = (_a = fiber.effectHooks[index]) === null || _a === void 0 ? void 0 : _a.deps;
                if (!action.deps || !isDepsEqual(action.deps, deps)) {
                    (_b = action.cleanup) === null || _b === void 0 ? void 0 : _b.call(action);
                }
            });
    ...
    function useState(initialState) {
        ...
        const oldHook = (_a = wipFiber.alternate) === null || _a === void 0 ? void 0 : _a.stateHooks[stateHooksIndex];
        const stateHook = {
